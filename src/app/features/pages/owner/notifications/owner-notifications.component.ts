...
interface DisplayNotification extends NotificationReadDto {
  filterCategory: 'stations' | 'payouts' | 'reviews' | 'other';
  icon: string;
  bg: string;
  color: string;
  timeLabel: string;
...
const TYPE_DISPLAY: Record<NotificationType, { category: DisplayNotification['filterCategory']; icon: string; bg: string; color: string }> = {
  [NotificationType.Booking]:    { category: 'other',    icon: 'bi-calendar-check-fill', bg: '#dcfce7', color: '#16a34a' },
  [NotificationType.Session]:    { category: 'other',    icon: 'bi-battery-charging',    bg: '#dcfce7', color: '#16a34a' },
  [NotificationType.Payment]:    { category: 'other',    icon: 'bi-credit-card-fill',    bg: '#fef3c7', color: '#92400e' },
  [NotificationType.Review]:     { category: 'reviews',  icon: 'bi-star-fill',           bg: '#fef3c7', color: '#92400e' },
  [NotificationType.Approval]:   { category: 'stations', icon: 'bi-shield-check',        bg: '#dcfce7', color: '#16a34a' },
  [NotificationType.Withdrawal]: { category: 'payouts',  icon: 'bi-currency-dollar',     bg: '#dbeafe', color: '#1d4ed8' },
